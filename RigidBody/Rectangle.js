var Rectangle = function (center, width, height, fix) {
    ...
    //0--Top;1--Right;2--Bottom;3--Left//mFaceNormal is normal of face toward outside of rectangle
...
Rectangle.prototype.move = function (v) {
    var i; for (i = 0; i < this.mVertex.length; i++) {
